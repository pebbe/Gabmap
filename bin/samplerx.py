...
try:
    ...
    u.html.exitMessage('Error', u.html.escape(str(sys.exc_info()[1])))
...
<html>
  <head>
    <title>map and samples for regular expression</title>
    <style type="text/css">
    <!--
    body {{
        margin: 2em 4em;
...
for place, word, aa, bb, cc in items[:mx]:
    ...
    '''.format(u.html.escape(aa), u.html.escape(bb), u.html.escape(cc)))
